import {resolvers} from '../property_release';
...
/*
 * describe('resolvers.PropertyRelease.owner', () => {
...
//     const res = await resolvers.PropertyRelease.owner({__ownerUserId}, null, context);
...
/*
 * describe('resolvers.PropertyRelease.oneToManyResources', () => {
 *   it('load data from the data source', async () => {
 *     const context = {
 *       dataSources: {
 *         UserCenter: {
...
/*
 *     const listSpy = context.dataSources.Licensing.propertyReleaseFollowers.findByInternalId;
 *     const mockList = {
...
//     const res = await resolvers.PropertyRelease.oneToManyResources({__internalId}, null, context);
