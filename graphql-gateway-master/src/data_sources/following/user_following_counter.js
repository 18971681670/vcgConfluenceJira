...
/**
 * API representing FollowingCounter from following
 */
export class UserFollowingCounter extends BatchableAPI {
  /**
  ...
  async bulkLoadData(keys) {
    ...
    const response = await this.get(`internal/graphql/followeeCounters/findByIds`, qs);
