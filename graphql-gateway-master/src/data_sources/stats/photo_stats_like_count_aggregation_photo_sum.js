 ...
 */
export class PhotoStatsLikeCountAggregationPhotoSum extends BatchableAPI {
  /**
  ...
  async bulkLoadData(keys, {from, to}) {
    ...
    const response = await this.get(`internal/graphql/me/photoStats/likeCount/timeAggregation/photos/sourceSumByIds`, qs);
