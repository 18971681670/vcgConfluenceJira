...
/**
 * Virtual resource: UserStatsAggregation
 */
export class UserStatsAggregation extends Node {
  /**
   ...
   */
  get resourceType() {
    return 'UserStatsAggregation';
  }

  /**
   * Whether this resource is queryable through the `node` or `nodeByLegacyId` queries.
   * @return {Boolean} Whether UserStatsAggregation resource is queryable. `false` by default.
   */
  get queryable() {
    return true;
  }
  ...
  /**
   * Map API response to UserStatsAggregation schema
  ...
  /**
   * Aysnc bulk fetch information of UserStatsAggregation resources
