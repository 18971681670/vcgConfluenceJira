...
/**
 * API representing PhotoPulse from content-stream
 */
export class PhotoPulse extends Node {
  /**
  ...
  async bulkLoadData(keys) {
    ...
    const response = await this.get(`internal/graphql/photoPulses/findByIds`, qs);
