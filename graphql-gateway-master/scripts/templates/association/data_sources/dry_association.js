...
export class __CLASS_NAME__ extends API {
   ...
   */
  async paginated__ASSOCIATED_RESOURCE_TYPE_PASCALCASE__IdList({pageNum, pageSize}, __RESOURCE_TYPE_CAMELCASE__Id, filter) {
    const qs = {
      page: pageNum,
      size: pageSize,
      // filter,
    ...
    return {
      ____ASSOCIATED_RESOURCE_TYPE_CAMELCASE__Ids: response.__ASSOCIATED_RESOURCE_TYPE_SNAKECASE___ids,
